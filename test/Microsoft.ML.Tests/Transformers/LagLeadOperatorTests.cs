...
namespace Microsoft.ML.Tests.Transformers
{
    public class LagLeadOperatorTests : TestDataPipeBase
    {
        ...
        [NotCentOS7Fact]
        public void LagNonStringGrainTest()
        {
            MLContext mlContext = new MLContext(1);
            var dataList = new[] {
        ...
        [NotCentOS7Fact]
        public void MoreComplexNonStringGrainLagLeadOffsetTest()
        {
            MLContext mlContext = new MLContext(1);
            var dataList = new[] {
                new { GrainA = 1d, ColA = 1.0, ColB = 1 },
                new { GrainA = 1d, ColA = 2.0, ColB = 2 },
                new { GrainA = 1d, ColA = 3.0, ColB = 3 },
            };
            var data = mlContext.Data.LoadFromEnumerable(dataList);
        ...
        [NotCentOS7Fact]
        public void SimpleNonStringGrainLeadOffset2Test()
        {
            MLContext mlContext = new MLContext(1);
            var dataList = new[] {
                new { GrainA = true, ColA = 1.0, ColB = 1 },
                new { GrainA = true, ColA = 2.0, ColB = 2 },
                new { GrainA = true, ColA = 3.0, ColB = 3 }
            };
            var data = mlContext.Data.LoadFromEnumerable(dataList);
